...
export default function Blog() {
  ...
  const [showMore4, setShowMore4] = useState(false); // New state for blog 4
  const [showMore5, setShowMore5] = useState(false); // New state for blog 5
  ...
  const toggleShowMore4 = () => setShowMore4(!showMore4); // New toggle function for blog 4
  const toggleShowMore5 = () => setShowMore5(!showMore5); // New toggle function for blog 5
            ...
            >
              ...
              <Button
                className={`toggle-button ${
                  index === 0
                    ? showMore1
                      ? "bg-read-less-bg text-read-less-text shadow-read-less"
                      : "bg-read-more-bg text-read-more-text shadow-read-more"
                    : index === 1
                    ? showMore2
                      ? "bg-read-less-bg text-read-less-text shadow-read-less"
                      : "bg-read-more-bg text-read-more-text shadow-read-more"
                    ...
                    ? "bg-read-less-bg text-read-less-text shadow-read-less"
                    : "bg-read-more-bg text-read-more-text shadow-read-more"
                } transform transition-transform ease-in-out duration-300 hover:scale-1`}
                onClick={
                  index === 0
                    ? toggleShowMore1
                    : index === 1
...
const data = [
  {
    ...
    image: img5,
    heading:
      "Embracing Tomorrow's Innovations: What's Next in Technology",
  ...
  },
  {
    ...
    about:
      "In today's academic world, students juggle multiple assignments and deadlines, often feeling overwhelmed. This is where assignment help services come to the rescue. However, not all services are created equal, and choosing the right one is crucial for success. Here's why it matters.",
    post: [
      {
  ...
  },
  {
    ...
    image: img3,
    heading:
      "Unleashing the Power of ROI: A guide to Maximizing Returns in Business",
