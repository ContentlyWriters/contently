            ...
            <SheetClose asChild key={item.id}>
              <Link href={item.path} className="w-full block">
                <Button
                  size="sm"
                  variant="link"
                  className="text-md font-normal hover:text-[#5b6cf2] transition-colors ease-in-out duration-300 text-left"
                >
                  {item.name}
                </Button>
              </Link>
          ...
          {isAuthenticated ? (
            <div className="grid gap-2">
              <SheetClose asChild>
                <Button
                  variant="outline"
                  className=" hover:bg-[#5b6cf2] hover:text-[#ffffff] border-[#3c46d5] border-opacity-100 inline w-[100px]"
              ...
              <SheetClose asChild>
                <Link href="/dashboard">
                  <Button 
                  variant="outline"
                   className="mb-4 hover:bg-[#5b6cf2] hover:text-[#ffffff] border-[#3c46d5] border-opacity-100">
                    Dashboard
                  </Button>
                </Link>
              </SheetClose>
