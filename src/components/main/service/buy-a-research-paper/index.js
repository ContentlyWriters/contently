...
const ResearchPaperPage = () => {
  ...
  >
    ...
    <span className="text-[#fff]">&#34;Research Paper Writing Services&#34;</span>
  </motion.h1>

  <motion.p
    className="text-[#f5f5f5] text-base sm:text-lg max-w-3xl mx-auto leading-relaxed"
    variants={fadeInUp}
    initial="hidden"
    animate="visible"
    transition={{ delay: 0.3, duration: 1 }}
  >
    Invest in expertly crafted research papers designed to meet your academic needs.
  </motion.p>
       ...
       <section className="relative py-12 bg-[#f5f7fa]">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 text-center">
          <motion.h4
            ...
            transition={{ duration: 0.4 }}
          >
            Ready to Craft Your Research Paper?
          </motion.h4>
          <motion.p
