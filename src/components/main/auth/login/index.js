...
const handleLogin = async () => {
  ...
  className="bg-white rounded-md shadow-2xl p-6 sm:p-8 w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-[360px] border-black border-2 relative mx-4 sm:mx-auto z-[100]"
